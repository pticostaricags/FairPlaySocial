...
{
    /// <summary>
    /// Creates the basic CRUD actions for controllers wit the attribute: 
    /// </summary>
    [Generator]
                ...
                foreach (var singleAttributeList in singleClassDeclarationSyntax.AttributeLists)
                {
                    foreach (var singleAttribute in singleAttributeList.Attributes)
                    {
                        ...
                        if (identifierText == "ControllerOfEntity")
                        {
                            ...
                            stringBuilder.AppendLine($"/// [AutoGenerated] Creates an entity of {entityName}");
                            stringBuilder.AppendLine("/// </summary>");
                            ...
                            stringBuilder.AppendLine("}");
                            stringBuilder.AppendLine("/// <summary>");
                            stringBuilder.AppendLine($"/// [AutoGenerated] Gets All {entityName}");
                            stringBuilder.AppendLine("/// </summary>");
                            ...
                            stringBuilder.AppendLine("}");
                            stringBuilder.AppendLine("/// <summary>");
                            stringBuilder.AppendLine($"/// [AutoGenerated] Deletes the specified {entityName}");
                            stringBuilder.AppendLine("/// </summary>");
                            ...
                            stringBuilder.AppendLine("}");
                            stringBuilder.AppendLine("/// <summary>");
                            stringBuilder.AppendLine($"/// [AutoGenerated] Updates the specified {entityName}");
                            stringBuilder.AppendLine("/// </summary>");
                            ...
                            stringBuilder.AppendLine("}");
                            stringBuilder.AppendLine("/// <summary>");
                            stringBuilder.AppendLine($"/// [AutoGenerated] Gets the {entityName} by Id");
                            stringBuilder.AppendLine("/// </summary>");
                            stringBuilder.AppendLine("[HttpGet(\"[action]\")]");
